                      ...
                      <div :id="item.id" class="panel-collapse in collapse" style="">
                        <div class="card-body">
                          ...
                          <ul>
                            ...
                            <router-link class="btn btn-success btn-md pull-right" v-b-tooltip.hover v-b-tooltip.rightbottom title="realizar pedido" :to="'/school/management/order/new/suggestion/'+item.id">Realizar pedido</router-link>
