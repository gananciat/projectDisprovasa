                ...
                <div class="card-body">
                  <div class="row">
                    <form>
                            ...
                            <div class="row">
                              <div class="col-md-12 col-sm-12">
                                <div class="form-group">
                                  ...
                                  />
                                  <FormError
                                    :attribute_name="'number_phone_school'"
                                    :errors_form="errors"
                                  ></FormError>
                                </div>
                              </div>
                              <div class="col-md-12 col-sm-12">
                                <div class="form-group">
                                  ...
                                  <multiselect
                                    v-model="companies_id_phone_school"
                                    v-validate="'required'"
                                  ...
                                  <FormError
                                    :attribute_name="'companies_id_phone_school'"
                                    :errors_form="errors"
                                  ></FormError>
                                </div>
                              </div>
                            ...
                            <div class="row">
                              ...
                              <div class="col-md-12 col-sm-12">
                                <div class="form-group">
                                  <label>Municipio</label>
                                  <multiselect
                                    v-model="form.municipalities_id_people"
                                    v-validate="'required'"
                                  ...
                                  <FormError
                                    :attribute_name="'municipalities_id_people'"
                                    :errors_form="errors"
                                  ></FormError>
                                </div>
                              </div>
                              ...
                              <div class="col-md-12 col-sm-12">
                                <div class="form-group">
                                  ...
                                  />
                                  <FormError
                                    :attribute_name="'direction_people'"
                                    :errors_form="errors"
                                  ></FormError>
                                </div>
                              </div>
                              ...
                              <div class="col-md-12 col-sm-12">
                                <div class="form-group">
                                  ...
                                  <b-form-checkbox
                                    ...
                                    name="president"
                                  >¿Los datos que está registrando, pertenecen a un presidente?</b-form-checkbox>
                                  <div class="text-right">
                                    <strong>{{ form.president ? 'Si es Presidente':'No es Presidente' }}</strong>
                                  </div>
                                </div>
                              </div>
                            </div>
                            ...
                            <div class="row">
                              <div class="col-md-12 col-sm-12">
                                <div class="form-group">
                                  ...
                                  />
                                  <FormError
                                    :attribute_name="'number_phone_person'"
                                    :errors_form="errors"
                                  ></FormError>
                                </div>
                              </div>
                              <div class="col-md-12 col-sm-12">
                                <div class="form-group">
                                  <label>Compania</label>
                                  <multiselect
                                    v-model="companies_id_phone_person"
                                    v-validate="'required'"
                                  ...
                                  <FormError
                                    :attribute_name="'companies_id_phone_person'"
                                    :errors_form="errors"
                                  ></FormError>
                                </div>
                              </div>
                      ...
                      <div class="col-md-12 col-sm-12 text-right">
                        <button type="button" class="btn btn-primary btn-sm" @click="createOrEdit">
  ...
  methods: {
    ...
    createOrEdit() {
      ...
      if (self.form.phone_school.length == 0) {
        self.$toastr.error(
          "es necesario registrar al meno un número de teléfono para la escuela.",
          "error"
        );
        existe = false;
      }
